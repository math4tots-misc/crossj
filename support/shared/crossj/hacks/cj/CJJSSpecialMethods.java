...
final class CJJSSpecialMethods {
    ...
    private static final List<Pair<String, CJJSSpecialMethodHandler>> OTHER = List.of(
        ...
        mkpair1("cjx.cordova.html.MouseEvent.altKey", a -> a + ".altKey"),
        mkpair1("cjx.cordova.html.MouseEvent.button", a -> a + ".button"),
        mkpair1("cjx.cordova.html.MouseEvent.clientX", a -> a + ".clientX"),
        mkpair1("cjx.cordova.html.MouseEvent.clientY", a -> a + ".clientY"),
        mkpair1("cjx.cordova.html.MouseEvent.ctrlKey", a -> a + ".ctrlKey"),
        mkpair1("cjx.cordova.html.MouseEvent.metaKey", a -> a + ".metaKey"),
        mkpair1("cjx.cordova.html.MouseEvent.movementX", a -> a + ".movementX"),
        mkpair1("cjx.cordova.html.MouseEvent.movementY", a -> a + ".movementY"),
        mkpair1("cjx.cordova.html.MouseEvent.shiftKey", a -> a + ".shiftKey"),

        mkpair1("cjx.cordova.html.MouseEvent.x", a -> a + ".clientX"),
        mkpair1("cjx.cordova.html.MouseEvent.y", a -> a + ".clientY"),

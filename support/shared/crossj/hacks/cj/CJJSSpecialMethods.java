...
final class CJJSSpecialMethods {
    ...
    private static final List<Pair<String, CJJSSpecialMethodHandler>> OTHER = List.of(
        ...
        mkpair1("cj.Char.codeUnitCount", a -> "(" + a + ">=0x10000?2:1)"),
        ...
        mkpair2("cj.String.codeAt", (a, b) -> a + ".charCodeAt(" + b + ")"),
        mkpair2("cj.String.codePointAt", (a, b) -> a + ".codePointAt(" + b + ")"),
        mkpair1("cj.String.toString", a -> a),
        mkpair2("cj.String.split", (a, b) -> a + ".split(" + b + ")"),
        mkpair2("cj.String.startsWith", (a, b) -> a + ".startsWith(" + b + ")"),
        mkpair3("cj.String.startsWithAt", (a, b, c) -> a + ".startsWith(" + b + "," + c + ")"),
        mkpair2("cj.String.endsWith", (a, b) -> a + ".endsWith(" + b + ")"),
        mkpair3("cj.String.endsWithAt", (a, b, c) -> a + ".endsWith(" + b + "," + c + ")"),
        mkpair2("cj.String.__contains", (a, b) -> a + ".includes(" + b + ")"),
        ...
        mkpair2("cjx.html.Window.field", (a, name) -> a + "[" + name + "]"),

        mkpair1("cjx.html.KeyboardEvent.altKey", a -> a + ".altKey"),
        mkpair1("cjx.html.KeyboardEvent.code", a -> a + ".code"),
        mkpair1("cjx.html.KeyboardEvent.ctrlKey", a -> a + ".ctrlKey"),
        mkpair1("cjx.html.KeyboardEvent.key", a -> a + ".key"),
        mkpair1("cjx.html.KeyboardEvent.metaKey", a -> a + ".metaKey"),
        mkpair1("cjx.html.KeyboardEvent.repeat", a -> a + ".repeat"),
        mkpair1("cjx.html.KeyboardEvent.shiftKey", a -> a + ".shiftKey"),

        mkpair1("cjx.html.MouseEvent.altKey", a -> a + ".altKey"),
        mkpair1("cjx.html.MouseEvent.button", a -> a + ".button"),
        mkpair1("cjx.html.MouseEvent.clientX", a -> a + ".clientX"),
        mkpair1("cjx.html.MouseEvent.clientY", a -> a + ".clientY"),
        mkpair1("cjx.html.MouseEvent.ctrlKey", a -> a + ".ctrlKey"),
        mkpair1("cjx.html.MouseEvent.metaKey", a -> a + ".metaKey"),
        mkpair1("cjx.html.MouseEvent.movementX", a -> a + ".movementX"),
        mkpair1("cjx.html.MouseEvent.movementY", a -> a + ".movementY"),
        mkpair1("cjx.html.MouseEvent.shiftKey", a -> a + ".shiftKey"),

        mkpair1("cjx.html.MouseEvent.x", a -> a + ".clientX"),
        mkpair1("cjx.html.MouseEvent.y", a -> a + ".clientY"),

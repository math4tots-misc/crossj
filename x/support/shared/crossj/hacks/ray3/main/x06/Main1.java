package crossj.hacks.ray3.main.x06;
...
public final class Main1 {
    public static void main(String[] args) {
        var filepath = "out/ray3/x06-1.bmp";
        ...
        var world = Surfaces.of(
                ...
                Sphere.withMaterial(Metal.withColor(Color.rgb(0.5, 0.2, 0.2)).andFuzz(1.5))
                        .andTransform(Matrix.scaling(0.5, 0.5, 0.5).thenTranslate(2.4, 0, -3.5)),
                Sphere.withMaterial(Dielectric.withRefractiveIndex(1.5))
                        .andTransform(Matrix.scaling(0.5, 0.5, 0.5).thenTranslate(0.5, 0, -1)),
                Sphere.withTransform(Matrix.scaling(1000, 1000, 1000).thenTranslate(0, -1000.5, -1)));
        ...
        IO.println("Writing to filepath " + filepath);

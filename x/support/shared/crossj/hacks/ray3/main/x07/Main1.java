package crossj.hacks.ray3.main.x07;
...
public final class Main1 {
    public static void main(String[] args) {
        var filepath = "out/ray3/x07-1.bmp";
        ...
        var world = Surfaces.of(
                Sphere.withMaterial(Lambertian.withColor(Color.rgb(0, 0, 1)))
                        .andTransform(Matrix.scaling(r, r, r).thenTranslate(-r, 0, -1)),
                Sphere.withMaterial(Lambertian.withColor(Color.rgb(1, 0, 0)))
                        .andTransform(Matrix.scaling(r, r, r).thenTranslate(r, 0, -1)));

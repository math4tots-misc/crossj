...
public final class Main4 {
    public static void main(String[] args) {
        var filepath = "out/ray3/x07-4.bmp";
        ...
        var lookFrom = Matrix.point(3, 3, 2);
        var lookAt = Matrix.point(0, 0, -1);
        var aperture = 2.0;
        var distanceToFocus = lookFrom.subtract(lookAt).magnitude();

        var camera = Camera.withDepthOfField(lookFrom, lookAt, Matrix.vector(0, 1, 0), M.TAU / 18,

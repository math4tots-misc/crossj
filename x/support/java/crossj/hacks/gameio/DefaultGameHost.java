...
public final class DefaultGameHost implements GameHost {
    ...
    public void run(Game game) {
        ...
        var panel = new JPanel() {
            ...
            public void update(Graphics g) {
                var update = Time.now();
                var status = game.update(update - lastUpdate);
                lastUpdate = update;
                if ((status & 2) != 0) {
                    // exit
                    System.exit(0);
    ...
    private static String keyToString(int key, boolean shift) {
        switch (key) {
            ...
            case KeyEvent.VK_LEFT: return "ArrowLeft";
            case KeyEvent.VK_UP: return "ArrowUp";
            case KeyEvent.VK_RIGHT: return "ArrowRight";
            case KeyEvent.VK_DOWN: return "ArrowLeft";
            ...
            case KeyEvent.VK_NUMPAD0: return "NUMPAD0";
            ...
            case KeyEvent.VK_INVERTED_EXCLAMATION_MARK: return "INVERTED_EXCLAMATION_MARK";
            ...
            case KeyEvent.VK_CONTEXT_MENU: return "CONTEXT_MENU";
            ...
            case KeyEvent.VK_UNDEFINED: return "UNDEFINED";
            default:
                return "" + key;
        }
    }
